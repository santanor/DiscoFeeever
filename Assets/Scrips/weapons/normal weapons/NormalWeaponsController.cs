...
public class NormalWeaponsController : MonoBehaviour {
    ...
    Vector3[] _normalWeaponsPosition;
	...
	void _Start () {
        ...
        {
            offset = i * 120f;
        //    _positionNormalWeapons[i] = new Vector3(80f + offset - _currentNormalWeapons[i].GetComponent<WeaponAbstractLWF>().lwf.width/2, 15f, -3);
    ...
    void Update()
    {
        ...
        {
            _currentNormalWeapons[j].transform.localPosition = Vector3.Lerp(_currentNormalWeapons[j].transform.position, _currentNormalWeapons[j].GetComponent<WeaponAbstractLWF>().PositionVector, 10f);
        }
    }
    ...
    void ReordenateWeapons(int j)
    {
        ...
        _currentNormalWeapons[3] = ChooseWeapon();
        _currentNormalWeapons[3].transform.parent = _barra.transform;
        _currentNormalWeapons[3].transform.localPosition = new Vector3( 80 + 360 - _currentNormalWeapons[3].GetComponent<WeaponAbstractLWF>().lwf.width/2,15, -3f);
        _currentNormalWeapons[3].collider2D.enabled = false;
        _currentNormalWeapons[3].GetComponent<WeaponAbstractLWF>().SetAlpha(0.5f);
